  ...
  return (
    <article className="max-w-4xl mx-auto px-6 py-16 text-neutral-300">
      ...
      <HeroReveal>
        ...
        <Link data-reveal href="/" className="inline-flex items-center gap-2 text-sm text-neutral-500 hover:text-white transition-colors mb-8 group">
        ...
        <header className="mb-8">
          <span data-reveal className="text-xs uppercase tracking-wider text-accent-soft font-semibold px-2.5 py-1 rounded bg-white/[0.04] border border-white/[0.02]">
            {project.project_type}
          </span>
          <h1 data-reveal className="text-3xl md:text-4xl font-semibold text-white tracking-tight leading-tight mt-4">
            {project.title}
          </h1>
        </header>
        ...
        <div data-reveal className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-8">
